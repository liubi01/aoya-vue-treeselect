<template>
  <div>
    ...
    <p>
      ...
      >
      <label
        ><input type="checkbox" v-model="openOnFocus" />Open on focus</label
      >
    </p>
    <p>
      <label
        ><input type="checkbox" v-model="clearOnSelect" />Clear on select</label
      >
      <label
        ><input type="checkbox" v-model="closeOnSelect" />Close on select</label
      >
    </p>
    <p>
      <label><input type="checkbox" v-model="alwaysOpen" />Always open</label>
      <label
        ><input type="checkbox" v-model="appendToBody" />Append to body</label
      >
