  ...
  data: () => ({
    props: [
      ...
      },
      {
        ...
        type: "Boolean",
        defaultValue: code("false"),
        description: `When an ancestor node is selected/deselected, whether its disabled descendants should be selected/deselected. You may want to use this in conjunction with ${code(
      ...
      },
      {
        ...
        type: "Boolean",
        defaultValue: code("false"),
        description: `Whether to enable ${link(
          "#async-searching",
          "async search mode"
        )}.`,
      },
      ...
      },
      {
        ...
        description: `Automatically load root options on mount. When set to ${code(
          "false"
        )}, root options will be loaded when the menu is opened.`,
      },
      {
      ...
      },
      {
        ...
        defaultValue: code("true"),
        description:
          "Whether <kbd>Backspace</kbd> removes the last item if there is no text input.",
      },
      {
        name: "beforeClearAll",
        type: encodeHTML(
          `Fn${makeArgNameList([])} 🡒 (Boolean | Promise<Boolean>)`
        ),
        defaultValue: code("() => true"),
        description: `Function that processes before clearing all input fields. Return ${code(
          "false"
        )} to stop values being cleared.`,
      },
      {
      ...
      },
      {
        ...
        type: "Boolean",
        defaultValue: code("true"),
        description: `Whether to cache results of each search request for ${link(
          "#async-searching",
          "async search mode"
        )}.`,
      },
      ...
      },
      {
        ...
        description: `Title for the "×" button when ${code(
          ':multiple="true"'
        )}.`,
      },
      {
        name: "clearOnSelect",
        type: "Boolean",
        defaultValue: `Defaults to ${code("false")} when ${code(
          ':multiple="true"'
        )}; always ${code("true")} otherwise.`,
        description: `Whether to clear the search input after selecting an option. Use only when ${code(
          ':multiple="true"'
        )}. For single-select mode, it ${strong(
          "always"
        )} clears the input after selecting regardless of the prop value.`,
      },
      {
        name: "clearValueText",
        type: "String",
      ...
      },
      {
        ...
        type: "Boolean",
        defaultValue: code("true"),
        description: `Whether to close the menu after selecting an option. Use only when ${code(
          ':multiple="true"'
        )}.`,
      },
      {
        ...
        type: "Number",
        defaultValue: code("0"),
        description: `How many levels of branch nodes should be automatically expanded when loaded. Set ${code(
          "Infinity"
      ...
      },
      {
        ...
        defaultValue: code("true"),
        description:
          "Whether <kbd>Delete</kbd> removes the last item if there is no text input.",
      },
      {
        name: "delimiter",
        type: "String",
      ...
      },
      {
        ...
        type: "Boolean",
        defaultValue: code("false"),
        description: `Whether to flatten the tree when searching (sync search mode only). See ${link(
      ...
      },
      {
        ...
        type: "Boolean",
        defaultValue: code("false"),
        description: `Whether to prevent branch nodes from being selected. See ${link(
      ...
      },
      {
        ...
        description: `Set to ${code(
          "true"
        )} to disable the fuzzy matching functionality, which is enabled by default.`,
      },
      {
        name: "flat",
        type: "Boolean",
        defaultValue: code("false"),
        description: `Whether to enable flat mode or not. See ${link(
          "#flat-mode-and-sort-values"
      ...
      },
      {
        ...
        type: "Boolean",
        defaultValue: code("false"),
        description: `Joins multiple values into a single form field with the ${code(
          "delimiter"
        )} (legacy mode).`,
      },
      {
        ...
        description: `Limit the display of selected options. The rest will be hidden within the ${code(
          "limitText"
        )} string.`,
      },
      {
      ...
      },
      {
        ...
        description: [
          `Used for dynamically loading options. See ${link(
            "#delayed-loading"
          )} for detailed information.`,
          `Possible values of ${code("action")}: ${code(
            '"LOAD_ROOT_OPTIONS"'
          )}, ${code('"LOAD_CHILDREN_OPTIONS"')} or ${code('"ASYNC_SEARCH"')}.`,
          `${code("callback")} - a function that accepts an optional ${code(
            "error"
          )} argument`,
      ...
      },
      {
        ...
        description: `Set ${code(
          "true"
        )} to allow selecting multiple options (a.k.a., multi-select mode).`,
      },
      {
        name: "name",
        type: "String",
        defaultValue: NO_DEFAULT_VALUE,
        description: `Generates a hidden ${code(
          "<input />"
      ...
      },
      {
        ...
        description: `Used for normalizing source data. See ${link(
          "#customize-key-names"
        )} for detailed information.`,
      },
      {
      ...
      },
      {
        ...
        type: code("node[]"),
        defaultValue: NO_DEFAULT_VALUE,
        description: `Array of available options. See ${link(
          "#basic-features"
        )} to learn how to define them.`,
      },
      {
        name: "placeholder",
        type: "String",
      ...
      },
      {
        ...
        description: `Set ${code(
          "true"
        )} if the search query should search in all ancestor nodes too. See ${link(
          "#nested-search"
        )} for example.`,
      },
      {
        ...
        description: `Text tip to prompt for async search. Used for ${link(
          "#async-searching",
          "async search mode"
        )}.`,
      },
      {
        ...
        type: "Boolean",
        defaultValue: code("false"),
        description: `Whether to show a children count next to the label of each branch node. See ${link(
          "#disable-branch-nodes"
        )} for example.`,
      },
      {
        ...
        description: `Used in conjunction with ${code(
          "showCount"
        )} to specify which type of count number should be displayed. <br>Acceptable values: ${code(
          '"ALL_CHILDREN"'
        )}, ${code('"ALL_DESCENDANTS"')}, ${code('"LEAF_CHILDREN"')} or ${code(
          '"LEAF_DESCENDANTS"'
        )}.`,
      },
      {
        ...
        type: "Boolean",
        defaultValue: NO_DEFAULT_VALUE,
        description: `Whether to show children count when searching. Fallbacks to the value of ${code(
          "showCount"
        )} when not specified.`,
      },
      {
        ...
        description: `In which order the selected options should be displayed in trigger & sorted in ${code(
          "value"
        )} array. Use only when ${code(':multiple="true"')}. See ${link(
          "#flat-mode-and-sort-values"
        )} for example. <br>Acceptable values: ${code(
          '"ORDER_SELECTED"'
        )}, ${code('"LEVEL"')} or ${code('"INDEX"')}.`,
      },
      {
        name: "tabIndex",
        type: "Number",
      ...
      {
        name: "value",
        type: `${code("id")} | ${code("node")} | ${code("id[]")} | ${code(
          "node[]"
        )}`,
        defaultValue: NO_DEFAULT_VALUE,
        description: `The value of the control. <br>Should be ${code(
          "id"
        )} or ${code("node")} object when ${code(
          ':multiple="false"'
        )}, or an array of ${code("id")} or ${code("node")} object when ${code(
          ':multiple="true"'
        )}. Its format depends on the ${code(
          "valueFormat"
        )} prop. <br>For most cases, just use ${code("v-model")} instead.`,
      },
      {
        name: "valueConsistsOf",
        type: "String",
        defaultValue: code('"BRANCH_PRIORITY"'),
        description: `Which kind of nodes should be included in the ${code(
          "value"
        )} array in multi-select mode. See ${link(
          "#prevent-value-combining"
        )} for example. <br>Acceptable values: ${code('"ALL"')}, ${code(
          '"BRANCH_PRIORITY"'
        )}, ${code('"LEAF_PRIORITY"')} or ${code('"ALL_WITH_INDETERMINATE"')}.`,
      },
      {
        name: "valueFormat",
        type: "String",
        ...
        description: `Format of ${code(
          "value"
        )} prop. <br>Note that, when set to ${code('"object"')}, only ${code(
          "id"
        )} & ${code("label")} properties are required in each ${code(
          "node"
        )} object in ${code("value")}. <br>Acceptable values: ${code(
          '"id"'
        )} or ${code('"object"')}.`,
      },
      {
