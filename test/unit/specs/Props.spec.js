...
describe("Props", () => {
  ...
  describe("alwaysOpen", () => {
    ...
    it("should hide the arrow", async () => {
      ...
      expect(wrapper.contains(".vue-treeselect__control-arrow-container")).toBe(
        false
      );
    });
  ...
  describe("appendToBody", () => {
    const findPortalTarget = (vm) =>
      $(
        `.vue-treeselect__portal-target[data-instance-id="${vm.getInstanceId()}"]`
      );
  ...
  describe("clearAllText", () => {
    it('should be the title of "×" button when multiple=true', () => {
      ...
      expect(
        wrapper.find(".vue-treeselect__x-container").attributes().title
      ).toBe("$MULTI_TITLE$");
    });
  });
  ...
  describe("disableBranchNodes", () => {
    ...
    describe("when disableBranchNodes=false", () => {
      ...
      it("a branch node should have checkbox when multiple=true", async () => {
        ...
        expect(
          labelContainerOfBranchNode.contains(".vue-treeselect__checkbox")
        ).toBe(true);
      });
      ...
      it("a leaf node should have checkbox too when multiple=true", async () => {
        ...
        expect(
          labelContainerOfLeafNode.contains(".vue-treeselect__checkbox")
        ).toBe(true);
      });
  ...
  describe("limit", () => {
    ...
    it("when limit=1", () => {
      ...
      expect(wrapper.find(".vue-treeselect__limit-tip").text()).toBe(
        "and 3 more"
      );
    });
  });
    ...
    describe("when searchable=true", () => {
      describe("when multiple=true", () => {
        it("should show input", () => {
          ...
          expect(
            wrapper.contains(
              ".vue-treeselect__input-container .vue-treeselect__input"
            )
          ).toBe(true);
        });
    ...
    describe("when searchable=false", () => {
      describe("when multiple=true", () => {
        it("should not show input but a placeholder", () => {
          ...
          expect(wrapper.contains(".vue-treeselect__input-container")).toBe(
            true
          );
          expect(
            wrapper.find(".vue-treeselect__input-container").isEmpty()
          ).toBe(true);
        });
      });
  ...
  describe("showCountOnSearch", () => {
    ...
    it("should refresh count number after search changes", async () => {
      ...
      await typeSearchText(wrapper, "a");
      expect(
        findOptionByNodeId(wrapper, "a").find(".vue-treeselect__count").text()
      ).toEqual("(2)");
      expect(
        findOptionByNodeId(wrapper, "b").find(".vue-treeselect__count").text()
      ).toEqual("(1)");
